            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              >
                <textarea
                  ...
                  rows={1}
                  className="w-full resize-none overflow-hidden bg-transparent text-foreground placeholder:text-gray-300 dark:placeholder:text-gray-500 outline-none leading-snug px-3 py-1.5"
                  style={{
                    fontSize: 13.5,
                    minHeight: 28,
                    maxHeight: 160,
